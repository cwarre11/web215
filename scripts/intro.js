...
function getData() {
  ...
  let getSelectedValue = document.querySelector( 'input[name="prefer"]:checked');
      if(getSelectedValue != null) {
        var prefer = ("You prefer to work: " + getSelectedValue.value);
  }
  ...
  var choices = ("Your language you like better: " + output + ' ');


  //Send Data on
  let formData = [fullName, personalBackground, professionalBackground, academicBackground, backgroundInThisSubject, computerPlatform, courses, funnyInteresting, share, prefer, choices];
